              ...
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Data Collection Overview',
                          style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w700)),
                      const SizedBox(height: 16),
                      _buildBullet('GPS-based trip detection for start/end capture'),
                      _buildBullet('Distance, duration, and route summary storage'),
                      _buildBullet('User-provided mode, purpose, cost, and companions'),
                      _buildBullet('Local storage with safe sync-ready state'),
                      const Spacer(),
                      SwitchListTile.adaptive(
                        value: locationConsent,
                        onChanged: (value) => setState(() => locationConsent = value),
                        title: const Text('Enable Location Permission', style: TextStyle(color: Colors.white)),
                        subtitle: const Text('This must be enabled for trip detection to work.', style: TextStyle(color: Colors.white60)),
  ...
  Widget _buildBullet(String text) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('• ', style: TextStyle(color: AppColors.neonBlue, fontSize: 18)),
